<?php
/**
 * Class Netopia_Payment_Request
 * This class can be used for accessing NETOPIA Payments' interface for your configured online services
 * @copyright NETOPIA
...
class Netopia_Payment_Request
{
	...
	function Netopia_Payment_Request()
	{
	...
	public function builParametersList()
	{
		...
		$params['crc'] = Netopia_Global::buildCRC($params);
	...
	public function buildAccessParameters($public_key, &$env_key, &$enc_data)
	{
		...
		if(is_null($params))
			return false;
		$src_data = Netopia_Payment_Request::buildQueryString($params);
		$enc_data = '';
		$env_keys = array();
		$cipher_algo = 'RC4';
